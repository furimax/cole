...
import com.defenza.colegio.agenda.external.api.ErrorResponse;
import com.defenza.colegio.agenda.external.api.RestService;
...
public class CloudUsersDataSource implements ICloudUsersDataSource {
    ...
    //patron singleton para garantizar que solo se cree una instacia
    ...
    public void auth(final String email, final String password,
        ...
        String base64Credentials = Base64.encodeToString(formatCredentials.getBytes(), Base64.NO_WRAP);
