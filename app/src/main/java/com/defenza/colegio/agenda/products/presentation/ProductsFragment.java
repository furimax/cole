...
import com.defenza.colegio.agenda.productdetail.ProductDetailActivity;
import com.defenza.colegio.agenda.products.ProductsActivity;
import com.defenza.colegio.agenda.products.domain.model.Product;
import com.defenza.colegio.agenda.util.ActivityUtils;
...
public class ProductsFragment extends Fragment implements ProductsMvp.View {
    ...
    private static final java.lang.String ARGUMENT_ACTION_PICK = "ARGUMENT_ACTION_PICK";
    ...
    public void onResume() {
        super.onResume();
        mProductsPresenter.loadProducts(ProductsPresenter.ON_RESUME_LOAD_TYPE);
    }
        ...
        mProductsList.addOnScrollListener(
                new InfinityScrollListener(mProductsAdapter, layoutManager) {
                    ...
                    public void onLoadMore() {
                        mProductsPresenter.loadProducts(ProductsPresenter.NEW_PAGE_LOAD_TYPE);
                    }
                });
    }
    ...
    private void setUptRefreshLayout() {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                mProductsPresenter.loadProducts(ProductsPresenter.REFRESH_LOAD_TYPE);
            }
        });
    }
